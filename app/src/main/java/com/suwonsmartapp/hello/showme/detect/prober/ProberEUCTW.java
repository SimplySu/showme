...
import com.suwonsmartapp.hello.showme.detect.distribute.DistributeEUCTW;
import com.suwonsmartapp.hello.showme.detect.state.StateMachineCoding;
import com.suwonsmartapp.hello.showme.detect.state.StateMachineEUCTW;
import com.suwonsmartapp.hello.showme.detect.state.StateMachine;

public class ProberEUCTW extends ProberCharset {

    private StateMachineCoding codingSM;
    private ProbingState state;

    private DistributeEUCTW distributionAnalyzer;

    private byte[] lastChar;

    private static final StateMachine STATE_MACHINE = new StateMachineEUCTW();

    public ProberEUCTW() {
        super();
        this.codingSM = new StateMachineCoding(STATE_MACHINE);
        this.distributionAnalyzer = new DistributeEUCTW();
