...
public class StateMachineISO2022CN extends StateMachine {

    public static final int ISO2022CN_CLASS_FACTOR = 9;

    public StateMachineISO2022CN() {
        super(
                new Pakage(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, iso2022cnClassTable),
                ISO2022CN_CLASS_FACTOR,
                new Pakage(INDEX_SHIFT_4BITS, SHIFT_MASK_4BITS, BIT_SHIFT_4BITS, UNIT_MASK_4BITS, iso2022cnStateTable),
    ...
    private static int[] iso2022cnClassTable = new int[]{
            ...
            Pakage.pack4bits(0, 3, 0, 0, 0, 0, 0, 0),  // 28 - 2f
            Pakage.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),  // 30 - 37
            Pakage.pack4bits(0, 0, 0, 0, 0, 0, 0, 0),  // 38 - 3f
            Pakage.pack4bits(0, 0, 0, 4, 0, 0, 0, 0),  // 40 - 47
    ...
    private static int[] iso2022cnStateTable = new int[]{
            ...
            Pakage.pack4bits(START, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR),//08-0f
            Pakage.pack4bits(ERROR, ERROR, ITSME, ITSME, ITSME, ITSME, ITSME, ITSME),//10-17
            Pakage.pack4bits(ITSME, ITSME, ITSME, ERROR, ERROR, ERROR, 4, ERROR),//18-1f
            Pakage.pack4bits(ERROR, ERROR, ERROR, ITSME, ERROR, ERROR, ERROR, ERROR),//20-27
            Pakage.pack4bits(5, 6, ERROR, ERROR, ERROR, ERROR, ERROR, ERROR),//28-2f
            Pakage.pack4bits(ERROR, ERROR, ERROR, ITSME, ERROR, ERROR, ERROR, ERROR),//30-37
            Pakage.pack4bits(ERROR, ERROR, ERROR, ERROR, ERROR, ITSME, ERROR, START) //38-3f
    };
